...
CREATE TABLE "Conversation" (
  ...
  "messageCountByA" INTEGER NOT NULL DEFAULT 0,
  "messageCountByB" INTEGER NOT NULL DEFAULT 0,
  "lastMessageAt" DATETIME,
  "state" TEXT NOT NULL DEFAULT 'active',
  "endedAt" DATETIME,
  "videoDateStatus" TEXT NOT NULL DEFAULT 'none',
  "videoDateStartsAt" DATETIME,
  "videoDateEndsAt" DATETIME,
  "contactShareProposedAt" DATETIME,
  "contactShareAcceptedByUserA" BOOLEAN NOT NULL DEFAULT false,
  "contactShareAcceptedByUserB" BOOLEAN NOT NULL DEFAULT false,
  "contactInfoSharedAt" DATETIME,
  "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" DATETIME NOT NULL,
...
CREATE UNIQUE INDEX "PassSignal_userId_targetUserId_key" ON "PassSignal"("userId", "targetUserId");
